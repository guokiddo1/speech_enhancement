...
icpc -O3 -o enhance_resyth_IBM main.o extractwav.o MelProc.o -Wl,--start-group -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core -Wl,--end-group -liomp5 -lpthread -L/home/guocong/tools/asdk_20130701/asdk -lasdk 
