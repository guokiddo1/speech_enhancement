...
TextToParmKind(char *instr, int *parmKind)
{
  ...
  *parmKind = 0;
  ...
  else if (!strcmp(workstr, "LPC"))
    *parmKind += 1;
  else if (!strcmp(workstr, "LPREFC"))
    *parmKind += 2;
  else if (!strcmp(workstr, "LPCEPSTRA"))
    *parmKind += 3;
  else if (!strcmp(workstr, "LPDELCEP"))
    *parmKind += 4;
  else if (!strcmp(workstr, "IREFC"))
    *parmKind += 5;
  else if (!strcmp(workstr, "MFCC"))
    *parmKind += 6;
  else if (!strcmp(workstr, "FBANK"))
    *parmKind += 7;
  else if (!strcmp(workstr, "MELSPEC"))
    *parmKind += 8;
  else if (!strcmp(workstr, "USER"))
    *parmKind += 9;
  else if (!strcmp(workstr, "DISCRETE"))
    *parmKind += 10;
  else
    return 0;
