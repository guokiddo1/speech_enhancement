 ...
 *                                     FFT
 *----------------------------------------------------------------------------*/
#define NS_SPEC_ORDER                 (X_INT16)(129)//65
#define NS_FFT_ORDER                  (X_INT16)(8)
#define NS_FFT_LENGTH                 (X_INT16)(512)//256
...
#define NS_CUR_FRAME                  (X_INT16)(160)//80
#define NS_FRAME_SHIFT                (X_INT16)(160)//80
#define NS_BUFFER_SIZE                (X_INT16)(640)//320
#define NS_FRAME_LENGTH               (X_INT16)(480)//200
#define NS_DATA_IN_BUFFER             (X_INT16)(480)//240
#define NS_SCRATCH_MEM_SIZE           (NS_FFT_LENGTH)
#define NS_NB_FRAMES_LATENCY          (X_INT16)(2)
#define NS_ANALYSIS_WINDOW_8K         (X_INT16)(80)//60
